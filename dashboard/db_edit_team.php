  ...
  <main id="main" class="main">
    ...
    <div class="row">
                <?php
                    ...
                    $id=$_GET['id'];
                    //echo $id;
                    $id_data_receieve="select * from team where id =$id";
...
if(isset($_POST['name'])){
  ...
  if($photo['name'] == null){
   ...
   $description =$_POST['description'];
    ...
    $update_data = "UPDATE team SET name='$name', designation='$designation', description='$description', photo='$fname' where id =$id";
    // print_r($update_data);
