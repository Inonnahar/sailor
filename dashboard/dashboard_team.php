...
<div class="col-md-12"  id="list">
    <div class="row">
            <div>
                <h3>Team Information <a href="db_insert_team.php" id="create" class="btn btn-sm btn-primary" style="float:right ; width:10%;">Insert team</a></h3>
            ...
            $sl=0;
                ...
                ?>
                 <tr>
                    ...
                    <td style="width:10%">
                        <a href="db_edit_team.php?id=<?php echo $d['id']?>" class="btn btn-success btn-sm">Edit</a>
                        <a href="db_delete_team.php?id=<?php echo $d['id']?>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
