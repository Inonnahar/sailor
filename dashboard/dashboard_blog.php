...
<div class="col-md-12"  id="list">
    <div class="row">
            <div>
                <h3>Blog Information <a href="db_insert_blog.php" id="create" class="btn btn-sm btn-primary" style="float:right ; width:10%;">Insert blog</a></h3>
            ...
            $sl=0;
                ...
                ?>
                 <tr>
                    ...
                    <td style="width:10%">
                        <a href="db_edit_blog.php?id=<?php echo $d['id']?>" class="btn btn-success btn-sm">Edit</a>
                        <a href="db_delete_blog.php?id=<?php echo $d['id']?>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
