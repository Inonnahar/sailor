...
<div class="col-md-12"  id="list">
    <div class="row">
            <div>
                <h3>Service Information <a href="db_insert_service.php" id="create" class="btn btn-sm btn-primary" style="float:right ; width:10%;">Insert service</a></h3>
            ...
            $sl=0;
                ...
                ?>
                 <tr>
                    ...
                    <td style="width:10%"><img src="../upload/<?php echo $d['icon']?>" alt="" height="200px" width="200px"></td>
                    <td style="width:10%"><?php echo $d['title'] ?></td>
                   
                    <td style="width:10%"><?php echo $d['description'] ?></td>
                    
                    <td style="width:10%">
                        <a href="db_edit_service.php?id=<?php echo $d['id']?>" class="btn btn-success btn-sm">Edit</a>
                        <a href="db_delete_service.php?id=<?php echo $d['id']?>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
