...
?>
 <!-- End Sidebar-->
  ...
  <main id="main" class="main">
    ...
    <div class="row">
            <div>
                <h3>portfolio Information <a href="db_insert_portfolio.php" id="create" class="btn btn-sm btn-primary" style="float:right ; width:10%;">Insert portfolio</a></h3>
            ...
            $sl=0;
                ...
                ?>
                 <tr>
                    ...
                    <td style="width:10%">
                        <a href="db_edit_portfolio.php?id=<?php echo $d['id']?>" class="btn btn-success btn-sm">Edit</a>
                        <a href="db_delete_portfolio.php?id=<?php echo $d['id']?>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
