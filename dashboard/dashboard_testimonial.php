...
<div class="col-md-12"  id="list">
    <div class="row">
            <div>
                <h3>testimonial Information <a href="db_insert_testimonial.php" id="create" class="btn btn-sm btn-primary" style="float:right ; width:10%;">Insert testimonial</a></h3>
        ...
        <table class="table table-bordered table-hover table-responsive" style="margin-top:10px" >
            ...
            $sl=0;
                ...
                $get_all = "SELECT * FROM testimonial";
                ...
                ?>
                 <tr>
                    ...
                    <td style="width:10%"><?php echo $d['name'] ?></td>
                    <td style="width:10%"><?php echo $d['designation'] ?></td>
                    <td style="width:20%"><?php echo $d['description'] ?></td>
                    
                    <td style="width:10%">
                        <a href="db_edit_testimonial.php?id=<?php echo $d['id']?>" class="btn btn-success btn-sm">Edit</a>
                        <a href="db_delete_testimonial.php?id=<?php echo $d['id']?>" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
